...
public class BotResponseConstants {
    ...
    public static final String HELP_INFO = "<b>[ Как пользоваться ботом ]</b>\n"
        ...
        + "Можно <b>обнулить затраты</b> на клавиатуре, нажав "
        + "<code>'Управление категориями' » 'Обнулить счета'</code>.\n"
    ...
    public static final String SUMMARY_TIME_PERIOD_INFO = "Получить отчёт по всем категориям за:";
